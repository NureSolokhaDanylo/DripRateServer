        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StoreLink = table.Column<string>(type: "nvarchar(2048)", maxLength: 2048, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ColorCoordination = table.Column<int>(type: "int", nullable: false),
                    FitAndProportions = table.Column<int>(type: "int", nullable: false),
                    Originality = table.Column<int>(type: "int", nullable: false),
                    OverallStyle = table.Column<int>(type: "int", nullable: false),
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PublicationClothes", x => new { x.ClothesId, x.PublicationId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PublicationTags", x => new { x.PublicationId, x.TagsId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Assessments_UserId_PublicationId",
                table: "Assessments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PublicationClothes_PublicationId",
