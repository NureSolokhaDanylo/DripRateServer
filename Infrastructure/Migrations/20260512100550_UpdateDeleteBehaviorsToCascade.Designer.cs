...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260512100550_UpdateDeleteBehaviorsToCascade")]
    partial class UpdateDeleteBehaviorsToCascade
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AdvertisementTag", b =>
                {
                    ...
                    b.HasKey("AdvertisementId", "TagId");
            ...
            modelBuilder.Entity("Domain.AdvertisementView", b =>
                {
                    b.Property<Guid>("AdvertisementId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domain.Collection", b =>
                {
                    ...
                    b.HasIndex("IsPublic", "CreatedAt", "Id")
                        .IsDescending(false, true, false);

                    b.ToTable("Collections");
                });

            modelBuilder.Entity("Domain.CollectionPublication", b =>
                {
            ...
            modelBuilder.Entity("Domain.Publication", b =>
                {
                    ...
                    b.Property<decimal>("GameSnapshotPrice")
                        .ValueGeneratedOnAdd()
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)")
                        .HasDefaultValue(0m)
                    ...
                    b.HasIndex("_averageRating", "_assessmentsCount", "Id")
                        .IsDescending();

                    b.ToTable("Publications");
                });

            modelBuilder.Entity("Domain.PublicationGameStats", b =>
                {
                    b.Property<Guid>("PublicationId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<int>("FirstImpressionPositiveCount")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(0);

                    b.Property<long>("FirstImpressionReactionTimeSum")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                        .HasDefaultValue(0L);

                    b.Property<int>("FirstImpressionTotalCount")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(0);

                    b.Property<decimal>("GuessPriceGuessedSum")
                        .ValueGeneratedOnAdd()
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)")
                        .HasDefaultValue(0m);

                    b.Property<decimal>("GuessPriceRealSum")
                        .ValueGeneratedOnAdd()
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)")
                        .HasDefaultValue(0m);

                    b.Property<int>("GuessPriceTotalCount")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(0);

                    b.Property<int>("TagMatchCorrectCount")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(0);

                    b.Property<int>("TagMatchTotalCount")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(0);
            ...
            modelBuilder.Entity("Domain.UserGameHistory", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasKey("UserId", "PublicationId", "GameType");
            ...
            modelBuilder.Entity("AdvertisementTag", b =>
                {
                    b.HasOne("Domain.Advertisement", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.Publication", b =>
                {
                    ...
                    b.OwnsOne("Domain.MiniGameSettings", "GameSettings", b1 =>
                        {
                            b1.Property<Guid>("PublicationId")
                                .HasColumnType("uniqueidentifier");

                            b1.Property<bool>("IsFirstImpressionEnabled")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("bit")
                                .HasDefaultValue(true)
                                .HasColumnName("IsFirstImpressionEnabled");

                            b1.Property<bool>("IsGuessPriceEnabled")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("bit")
                                .HasDefaultValue(false)
                                .HasColumnName("IsGuessPriceEnabled");

                            b1.Property<bool>("IsTagMatchEnabled")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("bit")
                                .HasDefaultValue(false)
                                .HasColumnName("IsTagMatchEnabled");
            ...
            modelBuilder.Entity("Domain.PublicationGameStats", b =>
                {
                    b.HasOne("Domain.Publication", "Publication")
                        .WithOne("GameStats")
                        .HasForeignKey("Domain.PublicationGameStats", "PublicationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
